...
> **Estado: HISTÓRICO.** Este archivo conserva el diagnóstico inicial. No debe utilizarse para describir el stack o estado vigente; consultar `../01-resumen-ejecutivo-y-estado.md`.
