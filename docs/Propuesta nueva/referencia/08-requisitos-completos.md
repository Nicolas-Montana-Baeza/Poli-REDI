...
> **Estado: CATÁLOGO DETALLADO.** Se conserva RF-001 a RF-025, RNF-001 a RNF-012, historias y casos de uso. Para lectura ejecutiva usar `../03-requisitos-casos-uso-y-trazabilidad.md`.
