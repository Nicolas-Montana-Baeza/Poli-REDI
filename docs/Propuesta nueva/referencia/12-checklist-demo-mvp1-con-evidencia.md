...
> **Estado: EVIDENCIA HISTÓRICA DE DEMO.** Las capturas y estados se conservan; no prueban disponibilidad actual. Para una nueva ejecución usar `../07-calidad-pruebas-y-checklists.md`.
